...
<body>
	<div class="bgimg w3-display-container w3-text-white">
		...
		<div
			...
			<button
				...
				class="w3-button w3-black w3-round-large">로그인</button>
			<button
				onclick="document.getElementById('join').style.display='block'"
				class="w3-button w3-black w3-round-large">회원가입</button>
			<c:if test="${not empty mem.name}">
				<button
					onclick="document.getElementById('mypage').style.display='block'"
					class="w3-button w3-black w3-round-large">정보수정</button>
				<button
					onclick="document.getElementById('search').style.display='block'"
					class="w3-button w3-black w3-round-large">영화검색</button>
				<button onclick="location.href='TheaterServ?command=reserveMovie'"
		...
		<div class="w3-display-bottomright w3-container">
			...
			<p class="w3-large"></p>
			<p>
				powered by <a href="css/w3css/index.asp" target="_blank">A.P</a>
			</p>
		</div>
	</div>
	...
	<div id="login" class="w3-modal">
		<div class="w3-modal-content w3-animate-zoom" style="max-width: 30%">
			<div class="w3-container w3-black w3-display-container">
				<img src="img/flim.jpg" style="width: 100%"> <span
					...
					<form action="MemberServ" method="post">
						...
						<table border="1" cellspacing="1" width="90%">
							<tr>
								...
								<td width=55%><input type="text" name="id" size="25%"></td>
							</tr>
							<tr>
	...
	<div id="join" class="w3-modal">
		<div class="w3-modal-content w3-animate-zoom" style="max-width: 30%">
			<div class="w3-container w3-black">
				<span onclick="document.getElementById('join').style.display='none'"
					class="w3-button w3-display-topright w3-large">x</span>
				<center>
					<h1>회원가입</h1>
					<form action="MemberServ" method="post">
						...
						<table border="1" cellspacing="1" width="90%">
							<tr>
								<td width=45% align=center>아이디</td>
								<td width=55%><input type="text" name="id" size="25%">
								</td>
							</tr>
							<tr>
								<td width=45% align=center>비밀번호</td>
							...
							<tr>
								...
								<td width=55%><input type="text" name="name" size="25%">
								</td>
							</tr>
							<tr>
								<td width=45% align=center>이메일</td>
								<td width=55%><input type="email" name="email" size="25%">
								</td>
							</tr>
							<tr>
								<td width=45% align=center>전화번호</td>
								<td width=55%><input type="text" name="phone" size="25%">
								</td>
							</tr>
						</table>
						<br> <br>
