			...
			<div class="w3-modal-content w3-animate-zoom">
				<div class="w3-container w3-black">
					...
					<div style="width: 100%; height: 670px; overflow: auto;">
						<h3 align="center">상영중인 영화 목록</h3>
						<c:choose>
							<c:when test="${not empty list}">
								<c:forEach items="${list}" var="data">
									<div class="w3-row w3-third w3-card">
										<div class="w3-container w3-center w3-hover-dark-grey">
											<img
												src="${pageContext.request.contextPath}/img/${data.movieImg}"
											...
											<h4>${data.movieNm}</h4>
											<h5>${data.repGenreNm}/${data.movieRuntime}분</h5>
										</div>
									</div>
								</c:forEach>
							</c:when>
